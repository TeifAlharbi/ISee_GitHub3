    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('images/Ishihara_05.jpg'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
          ...
          Padding(
            padding: EdgeInsets.only(
                left: screenWeidth * 0.11, top: screenHeight * 0.840),
            child: Container(
              padding: EdgeInsets.only(left: 16.0, right: 16),
              decoration: BoxDecoration(
                  border: Border.all(color: Colors.black, width: 0.5),
              ...
              child: DropdownButton(
                ...
                onChanged: (newValue) {
                  setState(() {
                    IshiharaTestPlatesObject.valueChoose2 =
                        IshiharaTestPlatesObject.getSecondNumbercontroller
                            .toString();
              ...
              child: InkWell(
                onTap: () async {
                  if (IshiharaTestPlatesObject.valueChoose1 != null &&
                      IshiharaTestPlatesObject.valueChoose2 != null) {
                    if (IshiharaTestPlatesObject.valueChoose1 == "2" &&
                        IshiharaTestPlatesObject.valueChoose2 == "9") {
                    ...
                    FirebaseFirestore.instance
                        ...
                        .update({
                      'page5_choice1': IshiharaTestPlatesObject.valueChoose1,
                      'page5_choice2': IshiharaTestPlatesObject.valueChoose2,
                    ...
                    print(IshiharaTestPlatesObject.valueChoose2);
                    print(globals.correctAnswerCount);
                    print(globals.wrongAnswerCount);
                    print("Successfully Complete The Fifth Page");
