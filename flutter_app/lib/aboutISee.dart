...
class aboutISee extends StatefulWidget {
  @override
  _aboutISee createState() => _aboutISee();
}

class  _aboutISee extends State<aboutISee> {
  void initState() {
    super.initState();
  }
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Padding(
            padding: EdgeInsets.only(left:screenWeidth * 0.08 ,top: screenHeight  * 0.300 , right:screenWeidth * 0.08 , bottom: screenHeight  * 0.200),
            child: SizedBox(
              width:screenWeidth,
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 313.0, 395.0),
                    size: Size(313.0, 395.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(14.0, 35.0, 285.0, 360.0),
                    size: Size(313.0, 395.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: AutoSizeText(
                      'ISee is a mobile application developed to assist the color-blind people in their life routine.\n\nISee will determine and  distinguish certain shades of color to the color-blind people by using their camera phone.  ',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 24,
