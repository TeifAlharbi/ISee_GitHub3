...
class IshiharaTest extends StatefulWidget {
  @override
  _IshiharaTest createState() => _IshiharaTest();
}

class  _IshiharaTest extends State<IshiharaTest> {
  void initState() {
    super.initState();
  }
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          ),  //----------Already Took The Test Button----------
          Padding(
            padding: EdgeInsets.only(left:screenWeidth * 0.10 ,top: screenHeight  * 0.500
                , right:screenWeidth * 0.08 , bottom: screenHeight  * 0.200),
            child:  Container(
              child: SizedBox(
                width:screenWeidth,
          ...
          Padding(
            padding: EdgeInsets.only(left:screenWeidth * 0.10 ,top: screenHeight  * 0.600
                , right:screenWeidth * 0.08 , bottom: screenHeight  * 0.200),
            child:  Container(
              child: SizedBox(
             //   width: 252.0,
